...
- `ipv6_ns_interval` (Number)
- `ipv6_prefixes` (Attributes List) (see [below for nested schema](#nestedatt--ipv6_prefixes))
- `ipv6_ra_interval` (Number)
- `ipv6_ra_life_time` (Number)
- `ipv6_reachable_time` (Number)
...
- `override_default_fragment_setting_chain` (Number)
- `override_default_fragment_setting_size` (Number)
- `override_default_fragment_setting_timeout` (Number)
