...
func TestAccFmcDeviceBFD(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_device_bfd.test", "destination_object_id", "76d24097-41c4-4558-a4d0-a8c07ac08470"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_device_bfd.test", "source_object_id", "76d24097-41c4-4558-a4d0-a8c07ac08470"))
