...
var (
	_ datasource.DataSource              = &DynamicObjectsDataSource{}
	_ datasource.DataSourceWithConfigure = &DynamicObjectsDataSource{}
)

func NewDynamicObjectsDataSource() datasource.DataSource {
	return &DynamicObjectsDataSource{}
}
...
func (d *DynamicObjectsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the Dynamic Objects.").String,
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"type": schema.StringAttribute{
							MarkdownDescription: "Type of the object; this value is always 'DynamicObject'.",
							Computed:            true,
						},
