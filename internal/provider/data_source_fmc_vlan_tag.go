...
var (
	_ datasource.DataSource              = &VLANTagDataSource{}
	_ datasource.DataSourceWithConfigure = &VLANTagDataSource{}
)

func NewVLANTagDataSource() datasource.DataSource {
	return &VLANTagDataSource{}
}
...
func (d *VLANTagDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the VLAN Tag.").String,
