...
var (
	_ datasource.DataSource              = &StandardACLDataSource{}
	_ datasource.DataSourceWithConfigure = &StandardACLDataSource{}
)

func NewStandardACLDataSource() datasource.DataSource {
	return &StandardACLDataSource{}
}
...
func (d *StandardACLDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the Standard ACL.").String,
