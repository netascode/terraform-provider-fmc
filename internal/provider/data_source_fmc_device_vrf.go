...
var (
	_ datasource.DataSource              = &DeviceVRFDataSource{}
	_ datasource.DataSourceWithConfigure = &DeviceVRFDataSource{}
)

func NewDeviceVRFDataSource() datasource.DataSource {
	return &DeviceVRFDataSource{}
}
...
func (d *DeviceVRFDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_device_vrf"
}
...
func (d *DeviceVRFDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the Device VRF.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"type": schema.StringAttribute{
				MarkdownDescription: "Type of the object; this value is always 'VirtualRouter'.",
				Computed:            true,
			},
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"interface_id": schema.StringAttribute{
							MarkdownDescription: "UUID of the object (such as fmc_device_physical_interface.example.id, fmc_device_subinterface.example.id.",
							Computed:            true,
						},
