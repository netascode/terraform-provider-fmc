...
var (
	_ datasource.DataSource              = &SNMPAlertsDataSource{}
	_ datasource.DataSourceWithConfigure = &SNMPAlertsDataSource{}
)

func NewSNMPAlertsDataSource() datasource.DataSource {
	return &SNMPAlertsDataSource{}
}
...
func (d *SNMPAlertsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_snmp_alerts"
}
...
func (d *SNMPAlertsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the SNMP Alerts.").String,
		...
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.MapNestedAttribute{
				MarkdownDescription: "Map of SNMP Alerts. The key of the map is the name of the individual SNMP Alert.",
				Optional:            true,
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"type": schema.StringAttribute{
							MarkdownDescription: "Type of the object; this value is always 'SNMPAlert'.",
							Computed:            true,
						},
					},
				},
