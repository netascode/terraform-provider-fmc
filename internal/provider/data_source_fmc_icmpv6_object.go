...
var (
	_ datasource.DataSource              = &ICMPv6ObjectDataSource{}
	_ datasource.DataSourceWithConfigure = &ICMPv6ObjectDataSource{}
)

func NewICMPv6ObjectDataSource() datasource.DataSource {
	return &ICMPv6ObjectDataSource{}
}
...
func (d *ICMPv6ObjectDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_icmpv6_object"
}
