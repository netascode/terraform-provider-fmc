...
func (data Hosts) getPath() string {
...
func (data *Hosts) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *Hosts) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
