...
func (data SGT) toBody(ctx context.Context, state SGT) string {
	body := ""
...
func (data *SGT) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *SGT) fromBodyPartial(ctx context.Context, res gjson.Result) {
