...
var (
	_ datasource.DataSource              = &VLANTagsDataSource{}
	_ datasource.DataSourceWithConfigure = &VLANTagsDataSource{}
)

func NewVLANTagsDataSource() datasource.DataSource {
	return &VLANTagsDataSource{}
}
...
func (d *VLANTagsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the VLAN Tags.").String,
		...
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.MapNestedAttribute{
				MarkdownDescription: "Map of security zones. The key of the map is the name of the individual VLAN tag object. Renaming URL object in bulk is not yet implemented.",
				Optional:            true,
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id": schema.StringAttribute{
							MarkdownDescription: "UUID of the managed Vlan tag object.",
							Computed:            true,
						},
