...
func TestAccDataSourceFmcDeviceHAPair(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ha_pair.test", "use_same_link_for_failovers", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ha_pair.test", "shared_key", "cisco123"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ha_pair.test", "enc_key_generation_scheme", "CUSTOM"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ha_pair.test", "lan_failover_subnet_mask", "255.255.255.0"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ha_pair.test", "lan_failover_interface_id", "757kdgh5-41c4-4558-a4d0-a8c07ac08470"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_ha_pair.test", "lan_failover_interface_type", "PhysicalInterface"))
