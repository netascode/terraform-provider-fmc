...
func TestAccDataSourceFmcDeviceEtherChannelInterface(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_etherchannel_interface.test", "ipv6_enable_ra", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_device_etherchannel_interface.test", "auto_negotiation", "true"))
