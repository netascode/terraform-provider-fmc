...
var (
	_ datasource.DataSource              = &DeviceVRFIPv4StaticRouteDataSource{}
	_ datasource.DataSourceWithConfigure = &DeviceVRFIPv4StaticRouteDataSource{}
)

func NewDeviceVRFIPv4StaticRouteDataSource() datasource.DataSource {
	return &DeviceVRFIPv4StaticRouteDataSource{}
}
...
func (d *DeviceVRFIPv4StaticRouteDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config DeviceVRFIPv4StaticRoute
