...
var (
	_ datasource.DataSource              = &FQDNObjectsDataSource{}
	_ datasource.DataSourceWithConfigure = &FQDNObjectsDataSource{}
)

func NewFQDNObjectsDataSource() datasource.DataSource {
	return &FQDNObjectsDataSource{}
}
...
func (d *FQDNObjectsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the FQDN Objects.").String,
		...
		Attributes: map[string]schema.Attribute{
			...
			"items": schema.MapNestedAttribute{
				MarkdownDescription: "Map of FQDNs. The key of the map is the name of the individual FQDN. Renaming FQDNs in bulk is not yet implemented.",
				Optional:            true,
				Computed:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"id": schema.StringAttribute{
							MarkdownDescription: "UUID of the managed FQDN.",
							Computed:            true,
						},
						...
						"dns_resolution": schema.StringAttribute{
							MarkdownDescription: "Type of DNS resolution.",
							Computed:            true,
						},
