...
func (data Networks) getPath() string {
...
func (data Networks) toBody(ctx context.Context, state Networks) string {
	body := ""
...
func (data *Networks) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *Networks) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *Networks) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
