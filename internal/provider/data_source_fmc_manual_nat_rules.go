...
var (
	_ datasource.DataSource              = &ManualNatRulesDataSource{}
	_ datasource.DataSourceWithConfigure = &ManualNatRulesDataSource{}
)

func NewManualNatRulesDataSource() datasource.DataSource {
	return &ManualNatRulesDataSource{}
}

type ManualNatRulesDataSource struct {
	client *fmc.Client
}

func (d *ManualNatRulesDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_manual_nat_rules"
}

func (d *ManualNatRulesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Manual Nat Rules.",
...
func (d *ManualNatRulesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
func (d *ManualNatRulesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config ManualNatRules
