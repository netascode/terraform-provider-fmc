...
func TestAccDataSourceFmcURLGroups(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttrSet("data.fmc_url_groups.test", "items.port_group_1.id"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_url_groups.test", "items.port_group_1.description", "My URL group"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_url_groups.test", "items.port_group_1.urls", ""))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_url_groups.test", "items.port_group_1.literals", ""))
