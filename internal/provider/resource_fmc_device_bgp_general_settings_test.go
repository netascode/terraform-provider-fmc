...
func TestAccFmcDeviceBGPGeneralSettings(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttrSet("fmc_device_bgp_general_settings.test", "type"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_device_bgp_general_settings.test", "scanning_interval", ""))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_device_bgp_general_settings.test", "as_no_in_path_attribute", ""))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_device_bgp_general_settings.test", "aggregate_timer", ""))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_device_bgp_general_settings.test", "default_local_preference", ""))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_device_bgp_general_settings.test", "keepalive_interval", ""))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_device_bgp_general_settings.test", "hold_time", ""))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_device_bgp_general_settings.test", "min_hold_time", ""))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_device_bgp_general_settings.test", "next_hop_delay_interval", ""))
