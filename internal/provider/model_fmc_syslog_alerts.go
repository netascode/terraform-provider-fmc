...
func (data SyslogAlerts) getPath() string {
	return "/api/fmc_config/v1/domain/{DOMAIN_UUID}/policy/syslogalerts"
}
...
func (data SyslogAlerts) toBody(ctx context.Context, state SyslogAlerts) string {
	body := ""
...
func (data *SyslogAlerts) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *SyslogAlerts) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *SyslogAlerts) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
