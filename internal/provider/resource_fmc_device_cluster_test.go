...
func TestAccFmcDeviceCluster(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("fmc_device_cluster.test", "control_node_interface_name", "GigabitEthernet0/0"))
	checks = append(checks, resource.TestCheckResourceAttr("fmc_device_cluster.test", "control_node_interface_type", "PhysicalInterface"))
