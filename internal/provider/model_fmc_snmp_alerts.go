...
func (data SNMPAlerts) getPath() string {
...
func (data SNMPAlerts) toBody(ctx context.Context, state SNMPAlerts) string {
	body := ""
...
func (data *SNMPAlerts) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *SNMPAlerts) fromBodyPartial(ctx context.Context, res gjson.Result) {
...
func (data *SNMPAlerts) fromBodyUnknowns(ctx context.Context, res gjson.Result) {
