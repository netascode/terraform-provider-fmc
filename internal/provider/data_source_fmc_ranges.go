...
var (
	_ datasource.DataSource              = &RangesDataSource{}
	_ datasource.DataSourceWithConfigure = &RangesDataSource{}
)
...
func (d *RangesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: helpers.NewAttributeDescription("This data source can read the Ranges.").String,
