...
func (d *PhysicalInterfaceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the PhysicalInterface.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"device_id": schema.StringAttribute{
				MarkdownDescription: "ID of the device whose interface is being configured.",
				Required:            true,
			},
			...
			"enabled": schema.BoolAttribute{
				MarkdownDescription: "To enable the interface of not.",
				Computed:            true,
			},
