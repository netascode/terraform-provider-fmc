...
func TestAccDataSourceFmcFilePolicy(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_file_policy.test", "archive_depth", "3"))
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_file_policy.test", "archive_depth_action", "true"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.fmc_file_policy.test", "threat_score", "High"))
