...
func TestAccDataSourceFmcDeviceBGPGenerelSettings(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttrSet("data.fmc_device_bgp_generel_settings.test", "name"))
	checks = append(checks, resource.TestCheckResourceAttrSet("data.fmc_device_bgp_generel_settings.test", "type"))
