...
// it uses identical TF_VAR_reg_key. It panics on any error.
//
// Reads from env FTD_ADDR, FTD_USERNAME, FTD_PASSWORD, FMC_URL, TF_VAR_reg_key.
...
func MustInitFromEnv() {
	...
	if os.Getenv("TF_VAR_reg_key") == "" {
		panic("TF_VAR_reg_key env variable must be set")
	}
